...
export default function MarketChart({ symbol }: MarketChartProps) {
  ...
  return (
    <div className="bg-[#18181b]/90 border border-white/10 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-md">
      {/* Chart Header */}
      <div className="flex items-center justify-between p-4 border-b border-white/10 bg-[#18181b]/80">
        ...
        {/* Timeframe Selector */}
        <div className="flex items-center space-x-1 bg-[#232329]/80 rounded-lg p-1">
          {timeframes.map((tf) => (
            <button
              key={tf}
